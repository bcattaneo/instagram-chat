...
const chat = `
    <div style="margin-left: 19px;" class="mXkkY KDuQp" id="${chatIconId}">
        <a class="xWeGp" href="javascript:showOrHideChat('${chatBoxId}');">
...
// Toggles chat box
function showOrHideChat(chatBoxId) {
...
// Inject needed functions into page
function createSharedObjects() {
    var script = document.createElement('script');
    script.textContent = showOrHideChat.toString();
    console.log(showOrHideChat.toString());
